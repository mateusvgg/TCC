...
def prepare_ref_image(
    image_path: str, resize: bool = True
...
class LoadProjectionsData:
    ...
    def _gen_projections_obj(
        self, pc_name: str, projections: List[torch.Tensor]
    ) -> PlyProjections:
    ...
    def _get_refs_projections(
        self,
    ) -> Dict[str, tuple[PlyProjections, tuple[int, int]]]:
